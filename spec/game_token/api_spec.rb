...
describe GameToken::Api do
  ...
  context 'when the GET method is sent to /api/game_tokens/' do
    ...
    context 'when a StandardError has occurred' do
      it 'returns an error with a 500 response code' do
        allow(game_token_dao).to receive(:query).and_raise(StandardError)
  ...
  context 'when the GET method is sent to /api/game_tokens/:id' do
    ...
    context 'when a StandardError has occurred' do
      it 'returns an error with a 500 response code' do
        allow(game_token_dao).to receive(:find).and_raise(StandardError)
  ...
  context 'when the POST method is sent to /api/game_tokens/' do
    ...
    context 'when an App::CustomErrors::ItemAlreadyExistsError has occurred' do
  ...
  # PUT specs
  context 'when the PUT method is sent to /api/game_tokens/:id' do
    context 'with valid parameters' do
